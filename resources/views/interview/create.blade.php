...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0 text-gray-800">Schedule New Interview</h1>
        ...
        <div class="card-body">
            <form action="{{ route('interviews.store') }}" method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <select id="requirement_id" name="requirement_id" class="form-select @error('requirement_id') is-invalid @enderror" required>
                            ...
                            @foreach($requirements as $requirement)
                                <option value="{{ $requirement->id }}" {{ old('requirement_id', request()->get('requirement_id')) == $requirement->id ? 'selected' : '' }}>
                ...
                <div class="alert alert-info">
                    <i class="fas fa-info-circle me-2"></i> After scheduling, you'll be able to record interview results and feedback once the interview is completed.
                </div>
